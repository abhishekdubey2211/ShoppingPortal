...
public class RedisUtil {
	...
	public String convertObjToString(Object obj) {
		return new Gson().toJson(obj, new TypeToken<Object>() {
		}.getType());
	}
	...
	public <T> List<EndUserDTO> convertStringToObjType(String jsonString, TypeToken<T> typeToken) {
